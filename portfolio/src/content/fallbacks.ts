  ...
  experienceItems: [
    {
      ...
      durationMonths: 2,
      durationLabel: null,
      iconUrl: "/fallback-logo-endava.svg",
    ...
    },
    {
      ...
      durationMonths: 1,
      durationLabel: null,
      iconUrl: "/fallback-logo-motion-source.png",
...
export const projectsFallback: Project[] = [
  {
    ...
    screenshots: [
      ...
      { _key: "fb-ppa-2", ...localImage("/fallback-project-2.webp") },
      { _key: "fb-ppa-3", ...localImage("/fallback-project-5.webp") },
    ],
    demoVideoUrl: null,
  ...
  },
  {
    ...
    screenshots: [
      ...
      { _key: "fb-pp-2", ...localImage("/fallback-project-3.webp") },
      { _key: "fb-pp-3", ...localImage("/fallback-project-4.avif") },
    ],
    demoVideoUrl: null,
  ...
  },
  {
    ...
    screenshots: [
      ...
      { _key: "fb-tat-2", ...localImage("/fallback-project-1.webp") },
      { _key: "fb-tat-3", ...localImage("/fallback-project-3.webp") },
    ],
    demoVideoUrl: null,
